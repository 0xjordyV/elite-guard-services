...
class EmployeeAdmin(admin.ModelAdmin):
    ...
    def employee_preview(self, request, pk):
        ...
        context['employee_data'] = {
            ...
            "Estado Civil": employee.marital_status.name if employee.marital_status else "N/A",
            "Dirección": f"{employee.address_street} {employee.address_number}".title() if employee.address_street else "N/A",
            ...
            "C.P.": employee.postal_code if employee.postal_code else "N/A",
            "Teléfono": employee.phone if employee.phone else "N/A",
